...
async function getComments(req, res) {
    try {
        ...
        const query = await userDB.query(
            'SELECT u.nick, l.comment, l.rating FROM library l, users u WHERE u.mail = $1 AND u.mail = l.user_mail AND l.media_id = $2 AND l.info_id = $3',
