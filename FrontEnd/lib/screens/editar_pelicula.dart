...
class _EditarPeliCartelleraScreenState extends State<EditarPeliCartelleraScreen> {
  ...
  void initState() {
    ...
    titleController = TextEditingController(text: data?["name"] ?? "");
    castController = TextEditingController(text: data?["cast"] ?? "");
    descriptionController =
        TextEditingController(text: data?["description"] ?? "");
    releaseDateController =
        TextEditingController(text: data?["release"].toString() ?? "");
                    ...
                    try {
                      ...
                      if (success) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text('${titleController.text} ha sido ${widget.mode == "New" ? "añadida" : "modificada"} en la base de datos.')),
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
